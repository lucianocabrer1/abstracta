...
public class BaseTest extends ExecutionContext{
    ...
    public void SetUp(){
        ...
        THREAD_LOCAL_SPARK_REPORTER.config().setDocumentTitle("Regresion Automation - Educacion IT");
        ...
        //WebDriver driver = DriverManager.setUp(System.getenv("NAVEGADOR"));
        ...
        getDriver().get("http://opencart.abstracta.us/");
    }
